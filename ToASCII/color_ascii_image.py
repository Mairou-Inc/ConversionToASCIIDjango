...
class ArtConverter:
    def __init__(self, path, path_to_save, font_size, color_level):
        pg.init()
        self.path = path
    ...
    def save_image(self):
        ...
        bright_image = self.increase_brightness(cv2_img)
        image_name = str(randint(0, 99999999999999)) + '.jpg'
        
        cv2.imwrite(self.path_to_save + image_name, bright_image)
        return image_name
        

    def increase_brightness(self, image, value=1.2):
